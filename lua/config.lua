...
local on_attach = function(client, bufnr)
  ...
  if client.server_capabilities.documentFormattingProvider then
    vim.api.nvim_create_autocmd("BufWritePre", {
      buffer = bufnr,
      callback = function()
        -- For Go files, special handling for imports and formatting
...
-- Configure YAML language server (for Helm and regular YAML)
lspconfig.yamlls.setup {
  ...
  settings = {
    yaml = {
      schemas = {
        ["https://raw.githubusercontent.com/yannh/kubernetes-json-schema/master/v1.27.3-standalone-strict/all.json"] = "/*.yaml",
        ["https://raw.githubusercontent.com/instrumenta/kubernetes-json-schema/master/master-standalone/all.json"] = "/*.yaml",
...
-- Treesitter configuration update
